...
python scripts/aero/votes/1_get_sugar_pools.py
...
python scripts/aero/votes/2_filter_votable_pools.py
...
python scripts/aero/votes/3_enriched_votable_pools.py
...
python scripts/aero/helper/3_5_get_coingecko_token_ids.py
...
python scripts/aero/votes/4_live_epoch_fees_with_coingecko.py
...
python scripts/aero/votes/5_create_votes_dashboard.py
...
python scripts/aero/algo/optimizer_corrected_logic.py
...
python scripts/aero/analytics/vote_analytics.py
