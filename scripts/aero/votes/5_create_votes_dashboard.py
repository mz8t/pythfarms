...
LIVE_FEES_PATH = "data/aero/live_epoch_fees_usd.json"
OUTPUT_PATH    = "data/aero/votes_dashboard.json"


VOTER_ABI = json.load(open("abi/aero/Voter.json"))
VE_ABI = json.load(open("abi/aero/Ve.json"))
